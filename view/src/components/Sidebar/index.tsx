    ...
    >
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          {/* <!-- Menu Group --> */}
          <div>
            <h3 className="mb-4 ml-4 text-sm font-semibold text-bodydark2">{!sidebarOpen && 'MENU'}</h3>
            ...
            <ul className={`mb-6 flex flex-col gap-1.5 ${sidebarOpen && 'items-center justify-center'}`}>
              ...
              <li>
                <NavLink
                  to="/membership"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('membership') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <MdCardMembership size={21} />
                  {!sidebarOpen && 'Member Ship'}
                </NavLink>
              </li>
              {/* <!-- Menu Item MemberShip --> */}
              ...
              <li>
                <NavLink
                  to="/trainers"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('trainers') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <FaUserShield size={21} />
                  {!sidebarOpen && 'Trainers'}
                </NavLink>
              </li>
              {/* <!-- Menu Item Trainers --> */}
