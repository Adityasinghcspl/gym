      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className={`mb-6 flex flex-col gap-1.5 ${ sidebarOpen && 'items-center justify-center' }`} >
              {/* <!-- Menu Item Dashboard --> */}
              <li>
                <NavLink
                  to="/"
                  ...
                  return (
                    <React.Fragment>
                      ...
                      >
                        ...
                        {!sidebarOpen && 'Forms'}
                        <svg
                          className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${open && 'rotate-180'} ${sidebarOpen && 'hidden'}`}
                          width="20"
                          height="20"
                          viewBox="0 0 20 20"
                          fill="none"
